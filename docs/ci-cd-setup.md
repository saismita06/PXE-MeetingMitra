# CI/CD Setup for PXE MeetingMitra

This document explains how the Continuous Integration and Continuous Deployment (CI/CD) pipeline is set up for the PXE MeetingMitra project.

## Automatic Docker Image Building and Publishing

The PXE MeetingMitra project uses GitHub Actions to automatically build and publish Docker images to Docker Hub whenever changes are pushed to the repository.
